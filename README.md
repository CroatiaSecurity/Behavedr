...
Versioning: current product line is **0.3.x**. Prefer patch bumps (`0.3.7`) for incremental work; use a **minor** (`0.2` → `0.3`) when cumulative capability advances the line. See [docs/RELEASE.md](docs/RELEASE.md) §0.
